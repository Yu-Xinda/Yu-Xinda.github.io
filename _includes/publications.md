...
<div class="publications" style="max-width: 900px; margin: auto; font-size: 14px; line-height: 1.5;">
  ...
  <div class="col-sm-9" style="flex: 1;">
    ...
    <div class="author" style="margin-top: 8px; font-size: 14px; color: #000000; background-color: #ffffff;">{{ link.authors }}</div>
    <div class="periodical" style="margin-top: 6px; font-style: italic; font-size: 14px; color: #000000; background-color: #ffffff;">{{ link.conference }}</div>
  ...
  <!-- Abstract 内容（默认隐藏） -->
  {% if link.abstract %}
  <div class="abstract-content" style="display: none; margin-top: 10px; margin-right: 15px; background: #eef3f7; padding: 8px 10px; border-radius: 4px; font-size: 14px; line-height: 1.4; text-align: justify; color: #000000; background-color: #ffffff;">
    {{ link.abstract }}
  </div>
  {% endif %}
  ...
  <!-- BibTex 内容（默认隐藏） -->
  {% if link.bibtex %}
  <pre class="bibtex-content" style="display: none; margin-top: 5px; margin-right: 15px; background: #eef3f7; padding: 8px 10px; border-radius: 4px; font-size: 14px; line-height: 1.4; white-space: pre-wrap;">{{ link.bibtex }}</pre>
  {% endif %}
  </div>
</div>
</li>
