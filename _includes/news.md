...
<div style="font-size: 16px; line-height: 1.6; letter-spacing: 0.5px; text-align: justify;">
  ...
  <p>
    <span style="color: #000;">[</span><span style="color: #d9534f; font-weight: 900; font-family: 'Arial Black', 'Microsoft YaHei', sans-serif;">{{ item.time }}</span><span style="color: #000;">]</span> {{ item.description }}
  </p>
  {% endfor %}
</div>
